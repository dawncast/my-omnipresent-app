...
export default function Communities() {
  return (
<><div className='text-lg font-bold flex-auto mx-2 my-2 mb-5'>COMMUNITIES </div>
<h2 className='mx-2 mb-5 text-gray-500 text-sm font-medium'>Explore diverse communities, engage in enriching experiences, and connect with local groups. </h2>
      ...
      <img className="h-auto w-auto flex-shrink-0  bg-gray-300" src={community.imageUrl} alt="" />
          ...
          <div className="flex w-full items-center justify-between space-x-6 p-6">
            <div className="flex-1 truncate">
              ...
              <p className="mt-1 truncate text-sm text-gray-500">{community.title}</p>
            </div>
          </div>
          <div>
